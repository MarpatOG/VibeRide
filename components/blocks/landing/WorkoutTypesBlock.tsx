...
const WORKOUT_TYPE_POPUP_CONTENT_RU: Record<WorkoutTypeId, WorkoutTypePopupContent> = {
  ...
  core: {
    ...
    paragraphs: [
      ...
      'Четкая структура: разгон -> подъемы -> ускорения -> финальный драйв.'
    ],
  ...
  intervals: {
    ...
    paragraphs: [
      ...
      'Короткие мощные отрезки чередуются с активным восстановлением - все строго в такт музыке.',
  ...
  power: {
    lead: 'Сила ног. Контроль. Тяжелый ритм.',
    paragraphs: [
      'Тренировка с акцентом на сопротивление и мощность.',
      'Больше подъемов, тяжелых участков и силовой работы в седле и стоя.',
  ...
  cinema: {
    ...
    paragraphs: [
      ...
      'Свет приглушен, атмосфера камерная, нагрузка адаптирована под длительный формат.',
